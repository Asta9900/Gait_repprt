...
if __name__ == '__main__':
    params = {
        ...
        'TFLITE_MODEL_PATH': 'D:/Capstone/Code2/GaitDetection/lite-model_movenet_singlepose_thunder_tflite_float16_4.tflite',          # File path of Human Pose Estimation model
        'VIDEO_FOLDER_PATH': 'D:/Capstone/Code2/GaitDetection/videos',                 # Folder where videos are present
        'DATA_SAVE_PATH': 'D:/Capstone/Code2/GaitDetection/newData'             # Folder where time series data needs to be saved
    }
